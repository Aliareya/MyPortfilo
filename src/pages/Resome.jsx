...
const Resome = () => {
  return (
    <div className="w-full h-[665px] bg-[#080808] flex flex-col items-center">
      <div className="w-full flex gap-5 justify-evenly mt-5">
        <div className="w-[37%] h-[500px] ">
          <div className="pb-[33px]">
            <h1 className="text-[#d1d1d1] flex gap-[11px] text-[40px]">
              <Icon icon="fluent-mdl2:education" style={{ color: "#ff8000" }} />
              Education
            </h1>
          </div>
              ...
              <div key={index} className="flex relative">
                <div className="relative group">
                  ...
                  <div className="pl-[33px] ml-[37px] border-l border-[#232935] pb-[17px]">
                    <h2 className="text-[#f4b400] mt-[13px] mb-[10px]">
                      Senior UX/UI Designer
                    </h2>
                    <p className="text-[#bbbbbb] italic mb-[5px]">
                      Jan 2020 - Present
                    </p>
