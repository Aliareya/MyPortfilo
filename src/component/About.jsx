...
const About = () => {
  return (
    <div className="w-full h-[700px] bg-black pt-12 flex flex-col items-center">
      <h1
        id="aboutme"
        className="text-center text-3xl border-b-2 border-orange-500 text-[#d1d1d1] mb-9 mt-2"
      >
        About Me
      </h1>
      <div className="w-full flex gap-8 items-center justify-center">
        {/* Photo Section */}
        <div
          className="w-1/3 h-[550px] bg-bottom bg-no-repeat bg-cover rounded-2xl opacity-55"
          style={{ backgroundImage: `url(${me})` }}
        ></div>

        {/* Info Section */}
        <div className="w-2/5 h-[550px] text-white flex flex-col justify-center pl-2">
          <h1 className="text-4xl pb-3">Hi There! I'm Alireza Ebrahimi</h1>
