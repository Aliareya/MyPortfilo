...
function Home() {
  return (
    <>
    <div className="flex justify-center  w-full h-[630px] -mt-3 bg-black bg-cover bg-fixed bg-top" style={{ backgroundImage: `url(${Backgrounng})` }}>
      <div className='w-1/2 h-[630px]  flex justify-center items-center pt-5 flex-col'>
        <div className="w-[290px] h-[290px] bg-cover bg-center bg-no-repeat rounded-full" style={{ backgroundImage: `url(${myimage})` }}></div>
        <div className='w-full'>
          <h1 className='text-6xl font-bold text-[#d1d1d1] text-center pt-2 '>Hi, i am <span className='text-[#ff6d2e]'>Alireza Ebrahimi</span> </h1>
